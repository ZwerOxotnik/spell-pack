...
fireball_projectile.animation = fireutil.create_fire_pictures({
	blend_mode = "normal",
	animation_speed = 1,
	scale = 0.5,
	shift = {0.05, 0.75}
...
data:extend({
	-- fireball_cat,
	fireball_grenade, fireball_projectile, fireball_explo, -- fireball_dmg,
	fireball_built, -- fireball_sticker,
	fireball_recipe
})
