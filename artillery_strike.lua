...
table.insert(projectile.final_action.action_delivery.target_effects, {
              type = "create-entity",
              entity_name = "osp_medium_scorchmark",
...
for i=0, 20 do
	...
	temp_projectile.final_action.action_delivery.target_effects[2].action.action_delivery.target_effects[1].damage.amount = 50+50*(i*0.6)
